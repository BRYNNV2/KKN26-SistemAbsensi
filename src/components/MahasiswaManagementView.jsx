...
export default function MahasiswaManagementView() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [searchQuery, setSearchQuery] = useState('');
  const [activeTabFilter, setActiveTabFilter] = useState('all');

  // Sample Mahasiswa Dataset matching HRIMS Employee screenshot
  ...
  return (
    <div className="mahasiswa-mgmt-container">
      {/* Top Header */}
      <div className="mgmt-header-bar">
        <div className="mgmt-title-group">
          <h1 className="mgmt-title">Mahasiswa KKN</h1>
          <p className="mgmt-sub">Kelola data & pendaftaran mahasiswa KKN62</p>
        </div>
        ...
        <div className="topbar-search-wrapper">
          ...
          <input 
            ...
            placeholder="Cari mahasiswa, NIM, kelompok KKN... (⌘K)" 
            value={searchQuery}
      ...
      {/* Main Content Grid (Table Left + Right Widgets) */}
      <div className="mgmt-content-grid">
        ...
        {/* Right Side Widgets (Distribution Donut + Recent Updates) */}
        <div className="mgmt-right-panel">
          {/* Kelompok Distribution Donut Widget */}
          ...
          {/* Recent Pendaftaran Updates Widget */}
          <div className="right-widget-card">
